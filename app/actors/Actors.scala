...
object Actors {
    ...
    def tweetLoaderDirect(implicit app: Application) = actors.tweetLoaderDirect
}
...
class Actors(app: Application) extends Plugin {
    ...
    private lazy val tweetLoaderDirect = system.actorOf(TweetLoader.props, "tweetLoader")
}
